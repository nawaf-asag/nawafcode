...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            'meta_keywords'       => [
                'نواف عساج, مطور برمجيات, مبرمج, مطور ويب, مطور Full Stack, مبرمج Laravel, مطور Laravel, مبرمج PHP, تصميم مواقع, تطوير مواقع, برمجة مواقع, تصميم متاجر إلكترونية, متجر إلكتروني, تطبيقات ويب, تطبيقات موبايل, مبرمج تطبيقات, Flutter, مطور Flutter, Vue.js, React, واجهات برمجية, REST API, قواعد بيانات, MySQL, SQL Server, Oracle, دعم فني, مهندس دعم فني, Onyx ERP, أنظمة ERP, أنظمة محاسبية, تحسين محركات البحث, SEO, مبرمج سعودي, مطور سعودي, جدة, السعودية, مبرمج يمني, صنعاء, خدمات برمجية, حلول برمجية, مبرمج مستقل',
                'Nawaf Asag, Nawaf Assaj, software developer, full stack developer, web developer, Laravel developer, PHP developer, Vue.js developer, React, JavaScript, website design, web development, ecommerce development, online store, web applications, mobile apps, Flutter developer, REST API, API development, database, MySQL, SQL Server, Oracle, technical support engineer, Onyx ERP, ERP systems, SEO, Saudi developer, Jeddah, Saudi Arabia, freelance developer, software solutions',
            ],
        ];
        ...
        // Experience & Education live in their own seeder so they can also be
        // run independently on production without overwriting other data.
        $this->call(ExperienceEducationSeeder::class);
